...
const ViewAllAllRejectedBookings = () => {
  ...
  const rejectedBookings = bookings.filter(booking => booking.status === "cancelled");
   ...
   const sortedBookings = rejectedBookings.slice().sort((a, b) => {
      ...
      <div className="flex">
        ...
        <section id="main-content" className="ml-64 flex-grow">
          ...
          <div className="container mx-auto mt-10 ml-10">
            <h2 className="text-2xl font-bold mb-4">View All Approved Bookings</h2>
            {isLoading ? (
              <p>Loading...</p>
            ) : isError ? (
              <p>{message}</p>
...
export default ViewAllAllRejectedBookings;
